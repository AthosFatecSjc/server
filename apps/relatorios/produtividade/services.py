...
from apps.relatorios.models import TempoGastoEquipe, Funcionario, MetaTempoControle
        ...
        for d in range(1, 32):
            ...
            if registro_dia:
                ...
                if tempo_gasto < 0:
                    ...
                    dias_por_func[d] = codigo_map.get(codigo_int, {'type': 'leave', 'value': '-'})
                elif tempo_gasto > 0:
...
def atualizar_codigo_especial(funcionario_id, mes, ano, dia, codigo):
    ...
    try:
        ...
        print(f"Atualizando código especial: funcionario_id={funcionario_id}, mes={mes}, ano={ano}, dia={dia}, codigo={codigo}")
